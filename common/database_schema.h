...
namespace DatabaseSchema {
	...
	static std::map<std::string, std::string> GetCharacterTables()
	{
		return {
			...
			{"character_aa_disabled",          "character_id"},
			...
			{"character_dynamic_aa_timers",    "character_id"},
	...
	static std::vector<std::string> GetPlayerTables()
	{
		return {
			...
			"spell_buckets",
			"spell_globals",
			"thj_waypoints_account",
			"thj_waypoints_character",
			"timers",
			"trader",
			"trader_audit",
			"zone_flags"
	...
	static std::vector<std::string> GetContentTables()
	{
		return {
			...
			"tasksets",
			"thj_waypoints",
			"thj_waypoints_categories",
			"thj_waypoints_default",
			"tradeskill_recipe",
