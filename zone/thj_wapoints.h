...
DROP TABLE IF EXISTS peq.thj_waypoints_account;
DROP TABLE IF EXISTS peq.thj_waypoints_character;
DROP TABLE IF EXISTS content.thj_waypoints_default;
DROP TABLE IF EXISTS content.thj_waypoints;
DROP TABLE IF EXISTS content.thj_waypoints_categories;

CREATE TABLE content.thj_waypoints_categories (
    id INT PRIMARY KEY,
    name VARCHAR(32) NOT NULL UNIQUE
);

CREATE TABLE content.thj_waypoints (
...
CREATE TABLE peq.thj_waypoints_character (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE peq.thj_waypoints_account (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE content.thj_waypoints_default (
    id INT AUTO_INCREMENT PRIMARY KEY,
    waypoint_id INT NOT NULL,
...
INSERT INTO content.thj_waypoints_categories (id, name) VALUES
(0, 'Antonica'),
(1, 'Faydwer'),
(2, 'Odus'),
(3, 'Kunark'),
...
INSERT INTO content.thj_waypoints (shortname, long_name, category, x, y, z, heading) VALUES
...
SELECT id, 1, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'freportw';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 1, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'qeynos2';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 2, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'halas';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 3, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'erudnext';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 4, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'gfaydark';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 5, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'felwithea';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 6, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'neriakb';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 7, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'freportw';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 7, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'qeynos2';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 7, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'gfaydark';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 8, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'kaladima';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 9, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'grobb';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 9, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'neriakb';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 10, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'oggok';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 10, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'neriakb';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 11, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'rivervale';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 12, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'akanon';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 128, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'cabeast';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 130, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'sharvahl';

INSERT INTO content.thj_waypoints_default (waypoint_id, race_id, class_mask, min_level, max_level)
SELECT id, 330, 65535, 1, 255 FROM content.thj_waypoints WHERE shortname = 'qeynos2';
...
INSERT IGNORE INTO peq.data_buckets (`key`, value, expires, account_id, character_id, npc_id, bot_id, zone_id, instance_id)
SELECT
...
CREATE OR REPLACE VIEW peq.v_thj_waypoints_summary AS
SELECT
    'Account Waypoints' as type,
    COUNT(DISTINCT account_id) as account_count,
    COUNT(*) as entry_count
FROM peq.thj_waypoints_account
UNION ALL
SELECT
    'Character Waypoints' as type,
    COUNT(DISTINCT character_id) as character_count,
    COUNT(*) as entry_count
FROM peq.thj_waypoints_character
UNION ALL
SELECT
    'Default Waypoints' as type,
    0 as account_count,
    COUNT(*) as entry_count
FROM content.thj_waypoints_default
UNION ALL
SELECT
    'Expanded Waypoints Settings' as type,
    COUNT(*) as account_count,
    COUNT(*) as entry_count
FROM peq.data_buckets WHERE `key` = 'expanded_waypoints'
UNION ALL
SELECT
    'Total Waypoints' as type,
    0 as account_count,
    COUNT(*) as entry_count
FROM content.thj_waypoints;
